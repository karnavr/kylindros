# Parameter grid search for KL model varying L
...
# Fixed parameters
branchN = 100
a1Vals = collect(range(0.01, 0.22, branchN + 1))
N = 36
b = 0.1
...
save_dir = "experiments/kl_grid_search"

# Create error log file
error_log_path = joinpath(dirname(@__DIR__), "results", "experiments", "kl_grid_search", "error_log.csv")
